...
class _$Movie$ implements Movie$ {
  ...
  @override
  String toString() {
    return 'Movie(title: $title, image: $image, rating: $rating, year: $year)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, image, rating, year);
...
abstract class Movie$ implements Movie {
  const factory Movie$(
      ...
      required final int year}) = _$Movie$;
